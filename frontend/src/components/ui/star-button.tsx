...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "relative z-[3] overflow-hidden px-6 py-4 inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-2xl text-sm font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 disabled:pointer-events-none disabled:opacity-50 group/star-button border border-[#C0FF00]/20 shadow-[0_0_30px_rgba(192,255,0,0.15)]",
        className,
      )}
      {...props}
    >
      ...
      <div
        ...
        style={{ borderWidth: "var(--border-width)", borderColor: "#C0FF00", borderStyle: "solid" }}
        aria-hidden="true"
      >
        <StarBackground color="#C0FF00" />
      </div>
      {/* Button label */}
      <span className="z-10 relative text-white font-black uppercase tracking-widest text-sm">
        {children}
      </span>
    </button>
  );
