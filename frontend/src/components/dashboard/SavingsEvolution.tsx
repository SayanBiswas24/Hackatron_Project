...
const SavingsEvolution: React.FC = () => {
  return (
      ...
      <CardHeader className="flex-row items-center justify-between pb-2">
        <div className="space-y-1">
          <CardTitle className="text-xl font-black tracking-tight flex items-center gap-2">
            Portfolio <span className="bg-[#C0FF00] px-2 py-0.5 rounded text-[0.65rem] text-black">Live</span>
          </CardTitle>
          <CardDescription className="text-xs text-gray-500 font-medium">Growth of your total savings across all vaults over time.</CardDescription>
        </div>
